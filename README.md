...
## Licensing Agreement
This is an entirely open-source projecy and you can do whatever you want on it. You can sell, use, redistribute, patent, fork, modify, claim ownership or include it on your other software.
